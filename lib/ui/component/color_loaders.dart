      ...
      child: Stack(
        children: <Widget>[
          new RotationTransition(
            turns: animation1,
            child: CustomPaint(
              painter: Arc1Painter(Theme.of(context).colorScheme.primary),
              child: Container(
                width: 50.0,
                height: 50.0,
              ),
          ...
          new RotationTransition(
            turns: animation2,
            child: CustomPaint(
              painter: Arc2Painter(Theme.of(context).colorScheme.surface),
              child: Container(
                width: 50.0,
                height: 50.0,
              ),
          ...
          new RotationTransition(
            turns: animation3,
            child: CustomPaint(
              painter: Arc3Painter(Theme.of(context).colorScheme.primaryVariant),
              child: Container(
                width: 50.0,
                height: 50.0,
              ),
